...
import { AlertCircle, ArrowRight, BrainCircuit, CheckCircle2, ShieldCheck, Sparkles } from "lucide-react";
            ...
            {!otpStep ? (
              ...
              <div className="mt-8 space-y-4">
                ...
                <button
                  ...
                  className="w-full text-sm text-white/85 underline decoration-white/40 underline-offset-2 transition hover:text-white"
                >
