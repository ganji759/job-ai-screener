...
type ActivityItem = {
  kind: "completed_screening" | "upload" | "job_change";
  action: string;
  jobName: string;
  timeAgo: string;
};

const dotColorByKind: Record<ActivityItem["kind"], string> = {
  completed_screening: "bg-emerald-500",
  upload: "bg-sky-500",
  job_change: "bg-amber-500",
};
          ...
          >
            ...
            <div>
              <p className="font-medium text-brand-900">
                {item.action} <strong>{item.jobName}</strong>
              </p>
